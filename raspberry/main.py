...
import board
import adafruit_dht
# Initialize the DHT with the data pin connected to pin 16 (GPIO 23) of the Raspberry Pi:
...
while True:
    try:
        ...
        print("Temp: {:.1f} F / {:.1f} C (temperature_f, temperature_c, humidity)) Humidity: {}% ".format(temperature_f, temperature_c, humidity))
